...
try {
    ...
    $error = "Error al obtener la lista de estudiantes: " . $e->getMessage();
}
?>
        ...
        <main class="main-content">
            ...
            <div class="content-wrapper">
                <div class="list-header">
                    ...
                    <a href="create_student.php" class="add-button">
                        ...
                        <?php else: ?>
                            <?php foreach($estudiantes as $estudiante): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($estudiante['documento_tipo'] ?? '') . ': ' . htmlspecialchars($estudiante['documento_numero'] ?? ''); ?></td>
                                    <td><?php echo htmlspecialchars($estudiante['nombre_acudiente']); ?></td>
                                    <td><?php echo htmlspecialchars($estudiante['telefono_acudiente']); ?></td>
                                    <td>
                                        <span class="status-badge status-<?php echo strtolower($estudiante['estado']); ?>">
                                            <?php echo ucfirst($estudiante['estado']); ?>
                                        </span>
                                    </td>
                                    <td class="actions">
                                        <a href="view_student.php?id=<?php echo $estudiante['id']; ?>" 
                                           class="btn-view" title="Ver">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="edit_student.php?id=<?php echo $estudiante['id']; ?>" 
